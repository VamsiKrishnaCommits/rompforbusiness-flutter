...
class _WeaklyrepState extends State<Weaklyrep> {
  ...
  void initState() {
    ...
    weekStartController.text = DateTime.now().subtract(Duration(days: DateTime.now().weekday)).toString().split(' ')[0];
    weekEndController.text = DateTime.now().add(Duration(days: 6 - DateTime.now().weekday)).toString().split(' ')[0];
  }
                    ...
                    IconButton(
                        ...
                        onPressed: () async {
                          final List<DateTime> picked = await DateRangePicker.showDatePicker(
                              ...
                              lastDate: DateTime.now().add(Duration(days:6- DateTime.now().weekday))
                          );
                          if(picked.length == 0){
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    StreamBuilder(
                        stream: databaseReference.child(token.tokenname).child(token.storename).child("DailySales").onValue,
                          ...
                          if (snapshot.hasData) {
                            ...
                            do{
                              ...
                              if(values.containsKey('$date')){
                                ...
                                DailyTotalList.add(DailyTotal(week[dates.weekday]+"\n"+dates.toString().split(' ')[0].substring(5).replaceAll('-','/'),0.0));
                                DailyTotalSales.add(DailyTotal(week[dates.weekday]+"\n"+dates.toString().split(' ')[0].substring(5).replaceAll('-','/'),0.0));
                              }
                              i++;
                            }while(date != DateEnd);
                              ...
                              children: <Widget>[
                                ...
                                Align(
                                  ...
                                  child: GestureDetector(
                                      ...
                                      child: Padding(padding: EdgeInsets.only(right: 25,bottom: 10), child: Text('View More',style: TextStyle(color: q==0? Colors.grey : Colors.deepPurple,letterSpacing: 0.3,fontWeight: FontWeight.w700)),)
                                  ),
                                ),
                              ],
                            );
                ...
                child: Column(
                  children: <Widget>[
                    Padding(
                      ...
                      child: Align(
                          alignment: Alignment.center,
                          child: Text('Weekly Analysis',style: TextStyle(fontSize: MediaQuery.of(context).size.height*0.12,fontFamily: 'DancingScript-Regular',fontWeight: FontWeight.w900,foreground: Paint()..shader = linearGradient))
                      ),
                    ),
                    Expanded(
                      child: Center(
                        child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(
                                  width: MediaQuery.of(context).size.width*(4/9)*0.3,
                                  child: Container(
                                      decoration: BoxDecoration(border: Border.all(width: 1.0)),
                                      child: TextField(
                                          textAlign: TextAlign.center,
                ...
                if (snapshot.hasData) {
                  ...
                  return Column(
                    children: <Widget>[
                      ...
                      SizedBox(height: 4),
                      Center(child: Text(totalSales.toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 30),key:ValueKey(key))),
                      SizedBox(height: 4),
                      Center(child: Text('Average Sales',style: TextStyle(fontSize: 35,color: Colors.deepPurple),textAlign: TextAlign.center)),
                      SizedBox(height: 4),
                      Center(child: Text((totalSales/q).toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 30),key:ValueKey(key))),
                      SizedBox(height: 4),
                        ...
                        child: Column(
                          children: <Widget>[
                            Padding(
                              ...
                              child: Center(child: Text('Revenue and Sales Table',textAlign: TextAlign.center,style: TextStyle(fontSize: 30),key:ValueKey(key))),
                            ),
                            FittedBox(
                              child: DataTable(
                                  columns: dataColumn,
